...
<div class="flex flex-col items-center">
    ...
    <form class="w-full max-w-lg m-4 pt-5" method="POST" action="{{ route('add.media') }}" enctype="multipart/form-data">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="email" name="files[]" type="file">
    ...
    <div class='w-full gap-2 flex flex-wrap justify-center m-10'>
        ...
        <div key={content} class="group relative rounded-lg overflow-hidden bg-white hover:shadow-2xl border-2">
            ...
            <div class="p-4">
                <img src="{{ asset($mediaItem->getUrl()) }}" alt='' class="h-72 w-full object-cover object-center">
            </div>
            @elseif($mediaItem->type == 'video')
            <div class="p-4">
                <video controls class="h-72 w-full object-cover object-center">
                    <source src="{{ asset($mediaItem->getUrl()) }}" type="video/mp4">
                </video>
            </div>
            @endif
